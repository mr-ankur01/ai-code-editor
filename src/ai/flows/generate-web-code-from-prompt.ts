...
const prompt = ai.definePrompt({
  ...
  - For any images, you MUST use 'https://placehold.co/<width>x<height>.png' for placeholder images (e.g., https://placehold.co/600x400.png).
